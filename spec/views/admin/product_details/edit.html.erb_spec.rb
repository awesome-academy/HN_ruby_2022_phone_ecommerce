...
RSpec.describe "admin/product_details/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit admin_product_detail form" do
    render

    assert_select "form[action=?][method=?]", admin_product_detail_path(@admin_product_detail), "post" do
